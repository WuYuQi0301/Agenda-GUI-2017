...
#include "../../../include/ui_/welcomedialog.h"
...
QT_MOC_LITERAL(4, 40, 25), // "on_RegisterBottom_clicked"
QT_MOC_LITERAL(5, 66, 21) // "on_QuitButton_clicked"

    },
    "WelcomeDialog\0command\0\0on_Login_clicked\0"
    "on_RegisterBottom_clicked\0"
...
void WelcomeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->command((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 1: _t->on_Login_clicked(); break;
        case 2: _t->on_RegisterBottom_clicked(); break;
        ...
        {
            typedef void (WelcomeDialog::*_t)(const int & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WelcomeDialog::command)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WelcomeDialog::command(const int & _t1)
{
