...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionComboBox = new QComboBox(centralWidget);
        actionComboBox->setObjectName(QStringLiteral("actionComboBox"));
        actionComboBox->setGeometry(QRect(120, 50, 261, 41));
        actionComboBox->setStyleSheet(QLatin1String("\n"
"font: 11pt \"Batang\";"));
        ...
        comfirmButton->setGeometry(QRect(140, 160, 101, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "Action", 0));
        comfirmButton->setText(QApplication::translate("MainWindow", "Comfirm", 0));
    } // retranslateUi
